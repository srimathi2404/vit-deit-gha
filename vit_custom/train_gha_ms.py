...
from gha_experiments.vit_msgha import ViT
import time
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("outputs_gha/loss_curve_msgha.png")
...
plt.ylabel("Accuracy")
plt.legend()
plt.savefig("outputs_gha/accuracy_curve_msgha.png")
...
plt.ylabel("Seconds")
plt.legend()
plt.savefig("outputs_gha/time_curve_msgha.png")
...
def analyze_attention():
    ...
    plt.axis('off')
    plt.savefig("outputs_gha/attention_map_msgha.png")
    plt.close()
    ...
    plt.savefig("outputs_gha/attention_histogram_msgha.png")
    plt.close()
    ...
    # 5. Save raw stats
    # -----------------------
    with open("outputs_gha/attention_stats_msgha.txt", "w") as f:

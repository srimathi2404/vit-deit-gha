...
from gha_experiments.vit import ViT
import time
...
plt.ylabel("Loss")
plt.legend()
plt.savefig("outputs_gha/loss_curve.png")
...
plt.ylabel("Accuracy")
plt.legend()
plt.savefig("outputs_gha/accuracy_curve.png")
...
plt.ylabel("Seconds")
plt.legend()
plt.savefig("outputs_gha/time_curve.png")
...
def analyze_attention():
    ...
    plt.savefig("outputs_gha/attention_histogram.png")
    plt.close()
    ...
    # 5. Save raw stats
    # -----------------------
    with open("outputs_gha/attention_stats.txt", "w") as f:
